...
func batchInsertSalarys(file *xlsx.File, id int, ep string) error {
	...
	for _, sheet := range file.Sheets {
		...
		for rowIndex, row := range sheet.Rows {
			...
			xzhj := strings.Trim(row.Cells[6].Value, " ")
			yjtc := strings.Trim(row.Cells[7].Value, " ")
			jjjs := strings.Trim(row.Cells[8].Value, " ")
			fdxs := strings.Trim(row.Cells[9].Value, " ")
			ydjj := strings.Trim(row.Cells[10].Value, " ")
			gzts := strings.Trim(row.Cells[11].Value, " ")
			jbf := strings.Trim(row.Cells[12].Value, " ")
			txbt := strings.Trim(row.Cells[13].Value, " ")
			csbt := strings.Trim(row.Cells[14].Value, " ")
			jtbt := strings.Trim(row.Cells[15].Value, " ")
			qtbt := strings.Trim(row.Cells[16].Value, " ")
			bthj := strings.Trim(row.Cells[17].Value, " ")
			qtjq := strings.Trim(row.Cells[18].Value, " ")
			njts := strings.Trim(row.Cells[19].Value, " ")
			cdkk := strings.Trim(row.Cells[20].Value, " ")
			bjts := strings.Trim(row.Cells[21].Value, " ")
			bjkk := strings.Trim(row.Cells[22].Value, " ")
			sjts := strings.Trim(row.Cells[23].Value, " ")
			sjkk := strings.Trim(row.Cells[24].Value, " ")
			kkhj := strings.Trim(row.Cells[25].Value, " ")
			yftz := strings.Trim(row.Cells[26].Value, " ")
			byyf := strings.Trim(row.Cells[27].Value, " ")
			dkwx := strings.Trim(row.Cells[28].Value, " ")
			gjj := strings.Trim(row.Cells[29].Value, " ")
			dkgs := strings.Trim(row.Cells[30].Value, " ")
